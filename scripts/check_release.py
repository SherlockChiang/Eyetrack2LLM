...
REQUIRED_FILES = ("PUBLIC_FILES.txt", ".gitignore", "README.md", "LICENSE", "CONTRIBUTING.md", "SECURITY.md", "CODE_OF_CONDUCT.md", "CITATION.cff", "pyproject.toml", ".github/workflows/ci.yml")
SECRET_PATTERNS = {
