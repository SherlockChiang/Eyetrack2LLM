...
Reproduction order, software versions, seeds, verification commands, compact result artifacts, and field-level provenance are provided in the archived project repository. This arXiv source bundle contains the manuscript, bibliography, tables, and four PDF figures needed to compile the paper. Primary stochastic seed was 20260711; optimization seeds were 101, 202, 303, 404, and 505. Versioned code and release artifacts are archived at \texttt{https://github.com/SherlockChiang/Eyetrack2LLM}.
